<?php
	...
	require_once(RCAL_PLUGIN_SRC_DIR . 'data/confirm-data.php');
	require_once(RCAL_PLUGIN_SRC_DIR . 'comp/confirm-component.php');

class Confirm_Control extends ResourceCalendar_Control  {
	...
	public function do_action() {
		...
		elseif ($this->action_class == 'Confirm_Edit' ) {
			...
			$this->comp->sendMail($reservation_data,true);
