<?php
	...
	require_once(RCAL_PLUGIN_SRC_DIR . 'data/category-data.php');
	require_once(RCAL_PLUGIN_SRC_DIR . 'comp/category-component.php');

class Category_Control extends ResourceCalendar_Control  {
